...
audioLink: 'https://audio.atriiy.me/Rebuilding%20My%20Blog%20in%202025_%20Next.js%20and%20Vercel'
...
![AWS Bill Memes](https://raw.githubusercontent.com/ShroXd/img-hosting/refs/heads/main/blog/aws-memes.png)
...
| ---------------------------------------------------------------------------------- | ---------------------------------------- |
| <NunitoSansWrapper>The quick brown fox jumps over the lazy dog</NunitoSansWrapper> | UI elements — buttons, navigation        |
...
| <JetBrainsMonoWrapper>The quick brown fox jumps over the lazy dog</JetBrainsMonoWrapper>   | Programming code                         |

So, the whole site runs on a warm color scheme with a mix of two sans-serif fonts (Nunito Sans and Montserrat) and a serif one (Spectral). I made sure the main color combo vibes with the [WCAG](https://www.w3.org/WAI/standards-guidelines/wcag/) guidelines. Maybe you want to ask why just the _main_ color? Well, some third-party components are a pain to tweak color-wise. 😣 Maybe I will find a time to mess with those later.
...
I didn't exactly study UX design in school (or programming either, for that matter 😅). But with a _little_ help from AI and a lot of coffee, I managed to cobble some design.
...
![Vibe Coding Memes](https://raw.githubusercontent.com/ShroXd/img-hosting/refs/heads/main/blog/vibe-coding-memes.png)
