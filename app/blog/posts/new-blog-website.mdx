...
Later, I realized that I could write some blog to record the experience or ideas about programming. So, I created a [blog website](https://atriiy.dev/) (Now this domain has been bought by a fucking illegal company) by using **Hexo**. It's a great tool but hard to use for me at that time.
